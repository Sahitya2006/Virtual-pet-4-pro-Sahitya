...
function preload(){
  ...
  bcgImage = loadImage("images/t.jpg");
}
...
function draw() {  
  ...
  var Bath=createButton("Let's bath");
  ...
  textSize(20);
  fill(255);
  text("Milk Bottles Remaining  "+foodS,200,600);
  text("Hi Friends",650,300)
  text("Let's play with trixy",600,350)
}
